// Defined by config.js, generated by setup.bat. Run setup.bat once per machine.
try {
  importScripts('config.js');
} catch (e) {
  // config.js not yet generated — MENU_PAGE_URL will be undefined
}
...
async function openMenu() {
  if (!MENU_PAGE_URL) {
    console.error('Menu Extension: run setup.bat to generate config.js');
    return;
  }
